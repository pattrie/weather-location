...
@FeignClient(name = "${feign.nominatim.name:nominatimClient}", url = "${feign.nominatim.url:nominatimClient}")
public interface NominatimClient {
  ...
  Optional<ReverseGeocodeJsonResponse> getReverseGeocode(
      @RequestParam("lat") final double latitude, @RequestParam("lon") final double longitude);
}
